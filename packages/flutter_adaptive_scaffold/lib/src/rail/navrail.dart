...
///
/// The appearance of all of the [ControllableNavRail]s within an app can be
...
///
/// {@tool dartpad}
/// This sample shows the creation of [ControllableNavRail] widget used within a Scaffold with 3
...
class ControllableNavRail extends StatefulWidget {
  ...
  /// Sets the color of the Container that holds all of the [ControllableNavRail]'s
  /// contents.
  ///
  ...
  /// Indicates that the [ControllableNavRail] should be in the extended state.
  ///
  ...
  final AnimationController? extendedController;
  ...
  /// a copy of the [IconThemeData.fallback] with a custom [ControllableNavRail]
  ...
  /// Overrides the default value of [ControllableNavRail]'s selection indicator color,
  ...
  /// Overrides the default value of [ControllableNavRail]'s selection indicator shape,
  /// when [useIndicator] is true.
  ///
  ...
  /// [ControllableNavRail]. Otherwise it precedes directly the main group of
  /// [destinations].
  ///
  ...
  /// [ControllableNavRail]. Otherwise it follows directly the main group of
  /// [destinations].
  ///
  /// See also [scrollable] for a description of the interplay of these
  /// parameters.
  ...
  /// Returns the animation that controls the [ControllableNavRail.extended] state.
  ///
  ...
  /// [ControllableNavRail].
  ///
  /// An instance of `MyNavigationRailFab` is created for [ControllableNavRail.leading].
  /// Pressing the FAB button toggles the "extended" state of the [ControllableNavRail].
  ///
  ...
  @override
  State<ControllableNavRail> createState() => _ControllableNavRailState();
}

class _ControllableNavRailState extends State<ControllableNavRail>
  ...
  @override
  void didUpdateWidget(ControllableNavRail oldWidget) {
...
class _RailDestinationState extends State<_RailDestination> {
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsets destinationPadding = (widget.padding ?? EdgeInsets.zero)
    ...
    switch (widget.labelType) {
      case NavigationRailLabelType.none:
        ...
        if (widget.extendedTransitionAnimation.value == 0.0) {
          content = Padding(
...
class _IndicatorInkWell extends InkResponse {
  ...
  RectCallback? getRectCallback(RenderBox referenceBox) {
    if (useMaterial3) {
      ...
      double indicatorHorizontalCenter = applyXOffset
          ? indicatorOffset.dx
          : boxWidth / 2;
