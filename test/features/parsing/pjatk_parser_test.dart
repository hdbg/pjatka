...
import 'package:pjatka/features/parsing/parsers/pjatk_parser.dart';
...
void main() {
  ...
  group('PjatkParser', () {
    ...
    test('parseDay returns classes for today', () async {
      ...
      for (final classItem in classes) {
        ...
        expect(classItem.range.start.isBefore(classItem.range.end), isTrue);
      }
    }, timeout: const Timeout(Duration(seconds: 60)));

    test('parseDay handles specific date', () async {
      ...
      for (final classItem in classes) {
        final classDate = classItem.range.start;
    ...
    test('parser can handle multiple sequential requests', () async {
